...
Khi tìm phòng, hệ thống không in đường dẫn `media_urls` trong tin nhắn. Ảnh/video được loại trùng và gửi trực tiếp dưới dạng Zalo attachment sau nội dung tư vấn. Biến `MAX_SEARCH_MEDIA` giới hạn số media mỗi lượt, mặc định là 10.
